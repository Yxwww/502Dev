		...
		okhttp3.ws.WebSocketListener
{
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Square.OkHttp3.WS.WebSocketListener, Square.OkHttp3.WS, Version=3.2.0.0, Culture=neutral, PublicKeyToken=null", WebSocketListener.class, __md_methods);
	}


	public WebSocketListener () throws java.lang.Throwable
	{
		super ();
		if (getClass () == WebSocketListener.class)
			mono.android.TypeManager.Activate ("Square.OkHttp3.WS.WebSocketListener, Square.OkHttp3.WS, Version=3.2.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
