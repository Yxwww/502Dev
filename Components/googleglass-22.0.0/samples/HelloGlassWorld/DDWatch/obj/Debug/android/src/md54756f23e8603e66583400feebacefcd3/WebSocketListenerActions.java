package md54756f23e8603e66583400feebacefcd3;


public class WebSocketListenerActions
		...
		okhttp3.ws.WebSocketListener
{
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Square.OkHttp3.WS.WebSocketListenerActions, Square.OkHttp3.WS, Version=3.2.0.0, Culture=neutral, PublicKeyToken=null", WebSocketListenerActions.class, __md_methods);
	}


	public WebSocketListenerActions () throws java.lang.Throwable
	{
		super ();
		if (getClass () == WebSocketListenerActions.class)
			mono.android.TypeManager.Activate ("Square.OkHttp3.WS.WebSocketListenerActions, Square.OkHttp3.WS, Version=3.2.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
